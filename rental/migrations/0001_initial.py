    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gearbox_types', models.CharField(choices=[('automatyczna', 'Automatyczna'), ('manualna', 'Manualna'), ('pol_automatyczna', 'Poł automatyczna')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(choices=[('dowod', 'dowód osobisty'), ('passport', 'paszport'), ('prawo_jazdy', 'prawo jazdy')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('karta', 'Karta'), ('gotowka', 'Gotówka'), ('przelew', 'Przelew'), ('blik', 'Blik')], max_length=20)),
